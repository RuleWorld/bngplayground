...
```bash
find C:\Users\Achyudhan\.gemini\antigravity\brain\ -name "walkthrough.md" -type f 2>/dev/null
```

keep in mind certain ones are like "walkthrough.md.resolved.3" so be aware.
