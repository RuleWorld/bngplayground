...
describeFn('An_2009 with BNG2.pl spawnSync', () => {
  it('should complete network generation AFTER running BNG2.pl spawnSync', async () => {
    // Find An_2009
    ...
    console.log('\n=== Testing An_2009 WITH BNG2.pl spawnSync FIRST ===\n');
